...
<html lang="en">
  ...
  <body>
   ...
   <h1><marquee><b ><font style="color:#FF0000;">Hospital Management System</font></b></marquee></h1>
    <div class="container">
	
      <form method="post" class="form-signin">
        <h2 class="form-signin-heading">Please sign in<br><font style="color:#BDB76B;">(For admin)</font></h2>
